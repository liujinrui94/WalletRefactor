...
public class CreditApplyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("信用卡申请");
        webview = (WebView) findViewById(R.id.credit_apply_wv);
        progressBar = (ProgressBar) findViewById(R.id.credit_apply_progressbar);
        getWindow().setFormat(PixelFormat.TRANSLUCENT);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE | WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        //设置WebView属性，能够执行Javascript脚本
        webview.getSettings().setJavaScriptEnabled(true);

        webview.loadUrl(Constant.MOBILE_HOST + "/fvp-qp-business/html/XYKSQ.html");
