...
public class ServiceGridViewAdapter extends BaseAdapter {
    ...
    public ServiceGridViewAdapter(Context context, ArrayList<ImageTextGridViewBean> imageTextGridViewBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_grid_service, null);
            viewHolder = new ViewHolder();
            viewHolder.gridItemTv = (TextView) convertView.findViewById(R.id.item_grid_service_tv);
            viewHolder.gridItemIv = (ImageView) convertView.findViewById(R.id.item_grid_service_iv);
